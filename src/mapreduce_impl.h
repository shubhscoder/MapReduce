#ifndef MAP_REDUCE_IMPL
#define MAP_REDUCE_IMPL
...
class MapReduceImpl {
	...
	private:
		...
		// Store the configuration of the map-reduce operation.
		MapReduceSpec mr_spec_;

		// List of the shards that will be distributed across map workers. 
